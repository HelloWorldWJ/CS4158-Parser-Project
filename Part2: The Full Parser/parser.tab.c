...
{
       0,    47,    47,    50,    53,    54,    57,    60,    63,    64,
      67,    67,    67,    67,    70,    71,    74,    75,    78,    81,
...
{
  "$end", "error", "$undefined", "IDENTIFIER", "CAPACITY", "INTEGER",
  "BEGINING", "BODY", "END", "MOVE", "TO", "ADD", "INPUT", "PRINT",
  "SEMICOLON", "STRING_LITERAL", "LINE_TERMINATOR", "$accept", "program",
  "beginning", "declarations", "declaration", "body", "operations",
  "operation", "move", "add", "input", "input_statement", "print",
  "print_statement", "end", YY_NULLPTR
};
#endif
...
#line 1387 "parser.tab.c"
  ...
  case 6:
#line 57 "parser.y"
                                                                                { addNewVariable((yyvsp[-2].capacity), (yyvsp[-1].name)); }
...
#line 1417 "parser.tab.c"
  ...
  case 14:
#line 70 "parser.y"
                                                                        { VarToVar((yyvsp[-3].name), (yyvsp[-1].name)); }
#line 1423 "parser.tab.c"
    break;

  case 15:
#line 71 "parser.y"
                                                                                { IntToVar((yyvsp[-3].number), (yyvsp[-1].name)); }
...
#line 1447 "parser.tab.c"
  ...
  case 19:
#line 81 "parser.y"
                                                                        { isIdentifierExists((yyvsp[-2].name)); }
#line 1453 "parser.tab.c"
    break;

  case 20:
#line 82 "parser.y"
                                                                                                { isIdentifierExists((yyvsp[-1].name)); }
